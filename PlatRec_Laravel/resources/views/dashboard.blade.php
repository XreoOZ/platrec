...
<body class="bg-gray-100">
    ...
    <header class="bg-gray-800 text-white h-20 flex items-center px-6 shadow-md">
        <div class="flex items-center space-x-3">
            ...
            <h1 class="text-xl font-semibold tracking-wide">Dashboard Admin - Plat Nomor</h1>
        </div>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
    ...
    <a href="/daftarstaff" class="feature-btn text-white text-center py-4 rounded-xl shadow-md transition" style="background:#f39c12;">
        <i class="fas fa-users block text-2xl mb-1"></i>
        <span class="font-medium">Daftar Staff</span>
    </a>
    <a href="/laporan" class="feature-btn text-white text-center py-4 rounded-xl shadow-md transition" style="background:#9b59b6;">
        <i class="fas fa-chart-line block text-2xl mb-1"></i>
